...
class MainWindow(QMainWindow):
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("http://www.symbaloo.com"))
...
# APPLICATION NAME
app.setApplicationName("Orbit Browser")
# APPLICATION COMPANY NAME
app.setOrganizationName("Orbit Company")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("orbit.org")
